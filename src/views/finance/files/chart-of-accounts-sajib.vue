    ...
    <div class="bg-white rounded-xl py-6 space-y-8 max-w-6xl mx-auto">
      <div class="bg-gray-50 rounded-lg shadow p-4 my-4">
        ...
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2 w-11/12">
            <label class="font-semibold block w-48">Account Code :</label>
            <a-input type="number" />
          </div>
          <a-input type="number" />
        ...
        <div class="flex items-center gap-4 mt-4">
          <label class="block font-bold w-36">Account Details</label>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        <div class="flex items-center gap-2">
          ...
          <a-select v-model:value="cashFlowId" class="w-full" placeholder="" ref="cashflow_id_ref">
          </a-select>
        </div>
      </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4 space-y-4 shadow relative ">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end py-6">
            <div class="flex items-center">
              ...
              <a-select class="w-full" v-model:value="selectedCategory" :disabled="!subLedger" ref="category_ref"
                @select="start_id_ref.focus()">
