  ...
  <MainLayout>
    ...
    <div class="">
      <div class="my-1">
        <a-form>
          <!-- form top -->
          <div class="px-2 bg-gray-100 rounded">
    ...
    <div class="rounded my-4 p-4 border border-gray-300">
      <!-- title -->
...
const fetchAccount_head = async (value) => {
  ...
  try {
    const { data } = await axios.get(
      `${apiBase}/journal/account-head?ACType1=${value || ""}`,
      getToken()
    );
