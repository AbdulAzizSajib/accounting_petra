    ...
    <div class="min-h-screen py-8 px-4">
      <div class="flex gap-2" v-if="!addNewMode">
        ...
        <div class="md:w-0/2 lg:w-1/4 mb-8">
          ...
          >
            <a-select-option
                v-for="code in employeeCodesFiltered"
                :key="code"
                :value="code"
            >
              {{ code }}
            ...
            <div class="mb-8 bg-gray-100 p-6 rounded-lg">
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <a-select
                        ...
                        class="h-10 w-full"
                        v-model:value="personal.bloodGroup"
                    >
                      <a-select-option
                  ...
                  <div>
                    ...
                    <a-select placeholder="Select Marital Status" class="h-10 w-full" v-model:value="personal.maritalStatus">
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <a-select
                        ...
                        class="h-10 w-full"
                        v-model:value="personal.religion"
                    >
                      <a-select-option
              ...
              <div class="mt-8 ">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Police Station / Upazila:</label>
                    <a-input class="h-10" v-model:value="personal.permanentAddress.policeStation" :disabled="permanentSame" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">District:</label>
                    <a-select placeholder="Select District" class="h-10 w-full"
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-4">
                  <div>
                    ...
                    <a-select placeholder="Select a Business" class="h-10 w-full" v-model:value="employee.business">
                      <a-select-option
                  ...
                  <div>
                    ...
                    <a-select placeholder="Select a Designation" class="h-10 w-full" v-model:value="employee.designation">
                      <a-select-option
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Contract From Date:</label>
                    <a-date-picker placeholder="dd/mm/yyyy" format="DD/MM/YYYY" class="w-full h-10"
                      v-model:value="employee.contractFrom" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Remuneration:</label>
                    <a-input class="h-10" v-model:value="employee.remuneration" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Job Location:</label>
                    <a-select placeholder="Select a Job Location" class="h-10 w-full" v-model:value="employee.jobLocation">
                      <a-select-option
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Supervisor staff ID:</label>
                    <a-input class="h-10" v-model:value="employee.supervisorStaffId" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Supervisor ContactNo:</label>
                    <a-input class="h-10" v-model:value="employee.supervisorContactNo" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Reason:</label>
                    <a-select placeholder="Select Reason" class="h-10 w-full" v-model:value="employee.reason">
                      <a-select-option
                          v-for="r in reasons"
                          :key="r.code"
                          :value="r.code"
                ...
                <div class="space-y-4">
                  <div>
                    ...
                    <a-select placeholder="Select a Department" class="h-10 w-full" v-model:value="employee.department">
                      <a-select-option
                  ...
                  <div>
                    ...
                    <a-date-picker placeholder="dd/mm/yyyy" format="DD/MM/YYYY" class="w-full h-10"
                      v-model:value="employee.joiningDate" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Expiry Date:</label>
                    <a-date-picker placeholder="dd/mm/yyyy" format="DD/MM/YYYY" class="w-full h-10"
                      v-model:value="employee.expiryDate" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Job Type:</label>
                    <a-select class="h-10 w-full" v-model:value="employee.jobType">
                      <a-select-option
                          v-for="j in jobTypes"
                          :key="j.code"
                          :value="j.code"
                  ...
                  <div>
                    ...
                    <a-input class="h-10" v-model:value="employee.location" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Supervisor name:</label>
                    <a-input class="h-10" v-model:value="employee.supervisorName" />
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Supervisor Designation:</label>
                    <a-select placeholder="Select Supervisor Designation" class="h-10 w-full"
                              v-model:value="employee.supervisorDesignation">
                      <a-select-option
                          v-for="d in designations"
                          :key="d.code"
                          :value="d.code"
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">ETIN:</label>
                    <a-input class="h-10" v-model:value="employee.etin" />
                  </div>
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Left Date:</label>
                  <a-date-picker placeholder="dd/mm/yyyy" format="DD/MM/YYYY" class="w-full h-10"
                    v-model:value="employee.leftDate" />
                </div>
              </div>
              <div class="mt-6">
                <label class="block text-sm font-medium text-gray-700 mb-1">Comment</label>
                <a-textarea :rows="4" placeholder="Enter any additional comments..." v-model:value="employee.comment" />
              </div>
            </div>
            <!-- Submit/Back Button -->
            <div class="flex justify-between mt-8">
              <a-button type="default" @click="prevStep">Back</a-button>
              <a-button
                  type="primary"
                  size="large"
